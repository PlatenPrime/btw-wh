...
Единственный эндпоинт: **GET `/api/defs/latest`** (роль ≥ USER). Контракт — [docs/api/defs.md](../api/defs.md). Breaking changes для UI — [docs/current/defs-live-calculation.md](../../current/defs-live-calculation.md).
