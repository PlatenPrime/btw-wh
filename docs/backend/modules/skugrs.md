...
Air refill при idle — SPA на странице конкурента Air (`air-capture` снимает HTML листинга) или unpacked-расширение [`extensions/air-skugr-fill`](../../extensions/air-skugr-fill): очередь `GET /api/skugrs/client/air/pending`, по страницам `POST /api/skugrs/client/air/id/:id/fill-page`. Контракт: [клиентский refill Air](../frontend/air-client-skugr-fill.md).
