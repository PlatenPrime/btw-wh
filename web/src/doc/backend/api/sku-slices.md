...
Excel-файл продаж по всем SKU конкурента за период с фильтром по производителю. Для каждого SKU строится блок из трех строк: `Продажі`, `Ціна`, `Виручка`.
...
**Ответ 200:** бинарный XLSX; имя файла вида `sku_sales_konk_<konk>_<prod>_<dateFrom>_<dateTo>.xlsx`.
