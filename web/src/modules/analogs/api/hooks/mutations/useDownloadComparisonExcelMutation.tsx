import { downloadComparisonExcel } from "@/modules/analogs/api/services/queries/downloadComparisonExcel";
...
export function useDownloadComparisonExcelMutation() {
  return useMutation({
    mutationFn: ({
      analogId,
      dateFrom,
      ...
      dateFrom: string;
      dateTo: string;
    }) => downloadComparisonExcel(analogId, dateFrom, dateTo),
