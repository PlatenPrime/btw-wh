import { downloadKonkSalesComparisonExcel } from "@/modules/analogs/api/services/queries/downloadKonkSalesComparisonExcel";
...
export function useDownloadKonkSalesComparisonExcelMutation() {
  return useMutation({
    mutationFn: ({
      konk,
      prod,
      ...
      downloadKonkSalesComparisonExcel({
        konk,
        prod,
        dateFrom,
        dateTo,
