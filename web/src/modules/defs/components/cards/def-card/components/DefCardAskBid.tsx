...
export function DefCardAskBid({ ask }: DefCardAskBidProps) {
  ...
  return (
    <div className="grid rounded-md border border-violet-200 bg-violet-100 p-2 text-xs text-violet-950 dark:border-violet-100/20 dark:bg-violet-800/20 dark:text-violet-100">
