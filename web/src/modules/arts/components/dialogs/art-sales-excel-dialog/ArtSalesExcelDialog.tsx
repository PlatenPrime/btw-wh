...
import { ArtSalesExcelDialogView } from "./ArtSalesExcelDialogView";
...
interface ArtSalesExcelDialogProps {
  artikul: string;
  open?: boolean;
  onOpenChange?: (open: boolean) => void;
}

export function ArtSalesExcelDialog({
  artikul,
  open: controlledOpen,
  onOpenChange,
}: ArtSalesExcelDialogProps) {
