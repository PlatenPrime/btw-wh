...
interface ArtStockExcelDialogViewProps {
...
export function ArtStockExcelDialogView({
  dateRange,
  onDateRangeChange,
  isExporting,
  onDownload,
  onCancel,
}: ArtStockExcelDialogViewProps) {
  ...
  return (
    <DialogContent className="sm:max-w-[425px]">
      <DialogHeader>
        <DialogTitle>Експорт Excel залишків</DialogTitle>
      </DialogHeader>
