import { downloadArtStockExcel } from "@/modules/arts/api/services/queries/downloadArtStockExcel";
...
export function useExportArtStockExcelMutation() {
  return useMutation({
    mutationFn: async ({
      artikul,
      dateFrom,
      ...
      dateFrom: string;
      dateTo: string;
    }) => downloadArtStockExcel(artikul, dateFrom, dateTo),
