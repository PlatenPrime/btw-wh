import { downloadArtSalesExcel } from "@/modules/arts/api/services/queries/downloadArtSalesExcel";
...
export function useExportArtSalesExcelMutation() {
  return useMutation({
    mutationFn: async ({
      artikul,
      dateFrom,
      ...
      dateFrom: string;
      dateTo: string;
    }) => downloadArtSalesExcel(artikul, dateFrom, dateTo),
