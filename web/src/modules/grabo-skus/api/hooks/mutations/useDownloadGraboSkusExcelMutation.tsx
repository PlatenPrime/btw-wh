import { downloadGraboSkusExcel } from "@/modules/grabo-skus/api/services/queries/downloadGraboSkusExcel";
...
export function useDownloadGraboSkusExcelMutation() {
  return useMutation({
    mutationFn: () => downloadGraboSkusExcel(),
