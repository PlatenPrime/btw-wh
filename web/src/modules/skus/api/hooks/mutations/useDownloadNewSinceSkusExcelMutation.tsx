import { downloadNewSinceSkusExcel } from "@/modules/skus/api/services/queries/downloadNewSinceSkusExcel";
...
export function useDownloadNewSinceSkusExcelMutation() {
  return useMutation({
    mutationFn: ({
      konkName,
      since,
      ...
      konkName: string;
      since: string;
    }) => downloadNewSinceSkusExcel(konkName, since),
