import { downloadInvalidSkusExcel } from "@/modules/skus/api/services/queries/downloadInvalidSkusExcel";
...
export function useDownloadInvalidSkusExcelMutation() {
  return useMutation({
    mutationFn: ({ konkName }: { konkName: string }) =>
      downloadInvalidSkusExcel(konkName),
