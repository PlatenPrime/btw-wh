import { downloadSkugrSalesExcel } from "@/modules/skugrs/api/services/queries/downloadSkugrSalesExcel";
...
export function useDownloadSkugrSalesExcelMutation() {
  return useMutation({
    mutationFn: ({
      skugrId,
      dateFrom,
      ...
      dateFrom: string;
      dateTo: string;
    }) => downloadSkugrSalesExcel(skugrId, dateFrom, dateTo),
