import { downloadSkugrSliceExcel } from "@/modules/skugrs/api/services/queries/downloadSkugrSliceExcel";
...
export function useDownloadSkugrSliceExcelMutation() {
  return useMutation({
    mutationFn: ({
      skugrId,
      dateFrom,
      ...
      dateFrom: string;
      dateTo: string;
    }) => downloadSkugrSliceExcel(skugrId, dateFrom, dateTo),
